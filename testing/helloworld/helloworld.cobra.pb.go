...
var _DefaultGreeterClientCommandConfig = _NewGreeterClientCommandConfig()

type _GreeterClientCommandConfig struct {
...
func _NewGreeterClientCommandConfig() *_GreeterClientCommandConfig {
	c := &_GreeterClientCommandConfig{}
	envconfig.Process("", c)
	return c
}

func (o *_GreeterClientCommandConfig) AddFlags(fs *pflag.FlagSet) {
...
func _DialGreeter() (*grpc.ClientConn, GreeterClient, error) {
	cfg := _DefaultGreeterClientCommandConfig
	...
	return conn, NewGreeterClient(conn), nil
}

type _GreeterRoundTripFunc func(cli GreeterClient, in iocodec.Decoder, out iocodec.Encoder) error

func _GreeterRoundTrip(sample interface{}, fn _GreeterRoundTripFunc) error {
	cfg := _DefaultGreeterClientCommandConfig
...
var _GreeterSayHelloClientCommand = &cobra.Command{
	Use:  "sayhello",
...
Authenticate using the Authorization header (requires transport security):
	...
	Run: func(cmd *cobra.Command, args []string) {
		var v HelloRequest
		err := _GreeterRoundTrip(v, func(cli GreeterClient, in iocodec.Decoder, out iocodec.Encoder) error {
...
func init() {
	GreeterClientCommand.AddCommand(_GreeterSayHelloClientCommand)
	_DefaultGreeterClientCommandConfig.AddFlags(_GreeterSayHelloClientCommand.Flags())
}
