...
func WithPlugins(svrs ...driver.Plugin) config.Option {
...
func WithAddr(network, addr string) config.Option {
	return func(c *config.Config) {
...
func WithGrpcAddr(network, addr string) config.Option {
	return func(c *config.Config) {
...
func WithGrpcInternalAddr(network, addr string) config.Option {
	return func(c *config.Config) {
...
func WithGatewayAddr(network, addr string) config.Option {
	return func(c *config.Config) {
...
func WithGrpcServerUnaryInterceptors(interceptors ...grpc.UnaryServerInterceptor) config.Option {
	return func(c *config.Config) {
...
func WithGrpcServerStreamInterceptors(interceptors ...grpc.StreamServerInterceptor) config.Option {
	return func(c *config.Config) {
...
func WithGatewayServerUnaryInterceptors(interceptors ...grpc.UnaryClientInterceptor) config.Option {
	return func(c *config.Config) {
...
func WithGatewayServerStreamInterceptors(interceptors ...grpc.StreamClientInterceptor) config.Option {
	return func(c *config.Config) {
...
func WithGrpcServerOptions(opts ...grpc.ServerOption) config.Option {
	return func(c *config.Config) {
...
func WithGatewayDialOptions(opts ...grpc.DialOption) config.Option {
	return func(c *config.Config) {
...
func WithGatewayMuxOptions(opts ...runtime.ServeMuxOption) config.Option {
	return func(c *config.Config) {
...
func WithGatewayServerMiddlewares(middlewares ...middleware.HTTPServerMiddleware) config.Option {
	return func(c *config.Config) {
...
func WithGatewayServerConfig(cfg *config.HTTPServerConfig) config.Option {
	return func(c *config.Config) {
...
func WithPassedHeader(decider middleware.PassedHeaderDeciderFunc) config.Option {
...
func WithDefaultLogger() config.Option {
	return func(c *config.Config) {
